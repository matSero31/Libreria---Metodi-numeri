function [bez_sx,bez_dx]=bezier_subdiv(bezier,x)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%function [bez_sx,bez_dx]=bezier_subdiv(bezier,x)
...
%questa function è una duplicazione della decast_subdiv, ma con 
%il nome bezier_subdiv affinché un utente possa essere facilitato 
%a capire cosa fa.
