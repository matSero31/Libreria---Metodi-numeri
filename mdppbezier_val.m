function Px=mdppbezier_val(mdppbez,t)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%function Px=mdppbezier_val(mdppbez,t)
...
%questa function è una duplicazione della mdppdecast_val, ma con 
%il nome mdppbezier_val affinché un utente possa essere facilitato 
%a capire cosa fa.
